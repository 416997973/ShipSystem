...
DELIMITER //
CREATE EVENT `autoRefreshInsert` ON SCHEDULE EVERY 1 DAY STARTS '2025-06-13 01:00:00' ON COMPLETION PRESERVE ENABLE DO BEGIN
...
DELIMITER //
CREATE EVENT `delete_request` ON SCHEDULE EVERY 1 DAY STARTS '2025-06-13 01:00:00' ON COMPLETION PRESERVE ENABLE DO BEGIN
...
DELIMITER //
CREATE EVENT `opt_owner` ON SCHEDULE EVERY 1 HOUR STARTS '2025-06-13 05:00:00' ON COMPLETION PRESERVE ENABLE DO BEGIN
