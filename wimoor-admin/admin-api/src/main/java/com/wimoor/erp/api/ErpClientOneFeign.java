...
public interface ErpClientOneFeign {
    ...
    @PostMapping("/erp/api/v1/material/getMaterialBySKU/{shopid}")
	...
	@GetMapping("/erp/api/v1/shipTransCompany/getShipTransChannelDetial")
	public Result<?> getShipTransChannelDetial( @RequestParam String channeDetaillid);
    ...
    @PostMapping("/erp/api/v1/material/getMskuByTagList/{without}")
	...
	@PostMapping("/erp/api/v2/shipForm/quotainfo")
	public Result<QuotaInfoDTO> quotainfoAction(@RequestBody  QuotaInfoDTO dto); 
	
	@PostMapping("/erp/api/v2/shipForm/outBoundShipInventory")
    public Result<Boolean> outBoundShipInventory(@RequestBody ShipFormDTO dto);
	
	@PostMapping("/erp/api/v2/shipForm/updateItemQty")
	public Result<Boolean> updateItemQty(@RequestBody ShipFormDTO dto);
	
	@PostMapping("/erp/api/v2/shipForm/updateDisable")
	public Result<Boolean> updateDisable(@RequestBody ShipFormDTO dto);
	
    @PostMapping("/erp/api/v2/shipForm/outShipInventory")
    public Result<Boolean> outShipInventory(@RequestBody ShipFormDTO dto);

	@GetMapping("/erp/api/v1/material/getCustoms")
	public Result<?> getCustomsAction(@RequestParam String msku,@RequestParam String country);

	@GetMapping("/erp/api/v1/thirdparty/getQuoteToken")
	public Result<?> getQuoteToken();
}