...
public class AmazonClientOneFeignManager {
	...
	public Result<ShipInboundShipmenSummarytVo> infosAction(List<String> shipments) {
		// TODO Auto-generated method stub
		return api.infosAction(shipments);
	}
    ...
    public Map<String,Object> getLastShipmentQty(Map<String,Object> param) {
		Result<Map<String,Object>> result = api.getLastShipmentQty(param);
		if(Result.isSuccess(result)&&result.getData()!=null) {
			return result.getData();
		}else {
			return null;
