...
import com.wimoor.erp.ship.pojo.entity.*;
...
public class ShipTransCompanyServiceImpl extends ServiceImpl<ShipTransCompanyMapper,ShipTransCompany> implements IShipTransCompanyService {
	...
	@Transactional
	public void uploadTransDetailByExcel(Sheet sheet, UserInfo user,String type)   {
...
//					QueryWrapper<ShipTransDetail> queryDetail=new QueryWrapper<ShipTransDetail>();
//					queryDetail.eq("company",company.getId());
//					shipTransDetailService.remove(queryDetail);
//				}
//			}
//		}
		for (int i = 1; i <= sheet.getLastRowNum(); i++) {
	...
	@Override
	public Boolean deleteIds(String[] idlist, UserInfo user) {
		// TODO Auto-generated method stub
		int i=0;
	...
	@Override
	public List<ThirdPartyAPI> loadApiCompany(UserInfo user) {
		return thirdPartyAPIService.getSupportApi(user,"logistics");
	}
	...
	@Override
	public ThirdPartyAPI getCompanyApiById(String companyid) {
		// TODO Auto-generated method stub
		ShipTransCompany com = this.baseMapper.selectById(companyid);
		if(com!=null&&com.getApi()!=null) {
			return thirdPartyAPIService.getById(com.getApi().toString());
		}else {
			return null;
		}
	}
