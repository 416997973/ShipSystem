...
public class OutWarehouseFormController {
	...
	public void downExcelTempAction(HttpServletResponse response) {
		try {
			...
			cell6.setCellStyle(formleft);
			cell6.setCellValue("操作类型:");
			cellright1 = row6.createCell(1);
			cellright1.setCellStyle(formright);
			cellright1.setCellValue("正品出库");
			cellright1.setCellType(CellType.STRING);
			...
			Row erow6 = sheet2.createRow(6);
			erow6.setHeight((short) (25 * 15));
			Cell ecell6 = erow6.createCell(0);
			ecell6.setCellStyle(formleft);
			ecell6.setCellValue("操作类型:");
			Cell ecell6_ = erow6.createCell(1);
			ecell6_.setCellStyle(formright);
			ecell6_.setCellValue("正品出库");
			
			Row etitleRow = sheet2.createRow(7);
			...
			Row ecotentRow = sheet2.createRow(8);
